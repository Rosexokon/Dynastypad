    ...
    <div className="pb-[10px]">
      <div className="container my-[50px]">
        <div className="flex flex-col rounded-[20px] gap-[30px] items-center border border-[#757575] py-[50px]">
          <a href="https://dynastypad.com/" className="flex items-center">
            <img src={Logo} className="h-8 mr-3" alt="Dynastypad Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Dynastypad</span>
          </a>
          <div>

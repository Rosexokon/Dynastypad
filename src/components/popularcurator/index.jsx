      ...
      <div>
        <div className="justify-center">
          <img
            ...
            className="h-48 w-full rounded-t-xl object-center object-cover"
          />
        </div>
      </div>
        ...
        <div className="mt-[-60px]">
          ...
          <div className="flex justify-between items-center flex-col mb-[12px]">
            <div className="flex justify-center items-center">
              <h1 className="text-[18px] font-[700] pr-2 text-[#000]">
                {item.title}
              </h1>
              <div className="text-[#4176FF]">
            ...
            <Link to={`/item/${item.id}`}>
              <div className="flex justify-center items-center p-2 w-24 bg-[#4176FF] text-[#ffffff] hover:bg-[#040429] text-center rounded-md">
                ...
                <button className="text-xs pl-2 flex items-center">
                  Follow{" "}
                </button>
              </div>
            </Link>
